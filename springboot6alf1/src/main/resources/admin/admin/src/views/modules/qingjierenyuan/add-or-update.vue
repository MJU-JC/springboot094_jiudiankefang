<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="清洁账号" prop="qingjiezhanghao">
          <el-input v-model="ruleForm.qingjiezhanghao" 
              placeholder="清洁账号" clearable  :readonly="ro.qingjiezhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="清洁账号" prop="qingjiezhanghao">
              <el-input v-model="ruleForm.qingjiezhanghao" 
                placeholder="清洁账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="清洁姓名" prop="qingjiexingming">
          <el-input v-model="ruleForm.qingjiexingming" 
              placeholder="清洁姓名" clearable  :readonly="ro.qingjiexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="清洁姓名" prop="qingjiexingming">
              <el-input v-model="ruleForm.qingjiexingming" 
                placeholder="清洁姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	qingjiezhanghao : false,
	mima : false,
	qingjiexingming : false,
	nianling : false,
	xingbie : false,
	shouji : false,
	zhaopian : false,
      ...
      rules: {
          qingjiezhanghao: [
                { required: true, message: '清洁账号不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='qingjiezhanghao'){
            this.ruleForm.qingjiezhanghao = obj[o];
	    this.ro.qingjiezhanghao = true;
            continue;
          }
          if(o=='mima'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='qingjiexingming'){
            this.ruleForm.qingjiexingming = obj[o];
	    this.ro.qingjiexingming = true;
            continue;
          }
          if(o=='nianling'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qingjierenyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qingjierenyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
