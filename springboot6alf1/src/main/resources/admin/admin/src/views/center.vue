  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qingjierenyuan'"  label="清洁账号" prop="qingjiezhanghao">
          <el-input v-model="ruleForm.qingjiezhanghao" readonly              placeholder="清洁账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='qingjierenyuan'"  label="清洁姓名" prop="qingjiexingming">
          <el-input v-model="ruleForm.qingjiexingming"               placeholder="清洁姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='qingjierenyuan'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='qingjierenyuan'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                v-for="(item,index) in qingjierenyuanxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qingjierenyuan'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='qingjierenyuan'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhaopian?ruleForm.zhaopian:''"
          @change="qingjierenyuanzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  mounted() {
    ...
    this.qingjierenyuanxingbieOptions = "男,女".split(',')
  },
  methods: {
    ...
    qingjierenyuanzhaopianUploadChange(fileUrls) {
        this.ruleForm.zhaopian = fileUrls;
    },
    onUpdateHandler() {
      ...
      if((!this.ruleForm.qingjiezhanghao)&& 'qingjierenyuan'==this.flag){
        this.$message.error('清洁账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'qingjierenyuan'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if( 'qingjierenyuan' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
